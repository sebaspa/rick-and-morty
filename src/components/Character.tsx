...
export const Character: React.FC<CharacterProps> = ({ character }) => {
  return (
    <div className="flex flex-col sm:flex-row gap-3 bg-gray-500 rounded-2xl">
      <img src={character.image} alt={character.name} className='w-full h-60 sm:w-48 sm:h-48 object-cover rounded-tl-2xl rounded-tr-2xl sm:rounded-tr-none sm:rounded-bl-2xl' />
